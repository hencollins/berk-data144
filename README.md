...
### 🗺️ The project
This project was kind of a failure, *BUT* failure is when we learn the most! 

I started with some EDA and preprocessing. Cleaning the data in itself was a major accomplishment (it was the least organized data I think I've ever seen) but I ended up making something usable. During preprocessing, I also made a grid over the continental US to subdivide the country by regions instead of states. 
